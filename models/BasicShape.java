					...
					if (dirLine != null)
					{
							...
							solInter.isWithinBounds())
						{
							...
							if (splitSides.size() > 1)
							{
								...
								for (int cSplit = 0; cSplit < splitSides.size(); cSplit += 2)
								{
